...
public class Ping extends UserlandProcess {
    ...
    public void main() throws InterruptedException, IOException {
        ...
        int targetPID = OS.GetPidByName("Pong");
        ...
        for (int i = 0; i < 100; i++) {
            ...
            cooperate();
            if (km != null)
                System.out.println("PONG: from: " + OS.GetPID() + " to " + targetPID + ". What: " + data[0]);
            else {
                System.out.println("Error from PING: Message not received");
            }
            km = null;
            Thread.sleep(500);
        }
